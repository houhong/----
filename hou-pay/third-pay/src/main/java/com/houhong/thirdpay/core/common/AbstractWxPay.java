...
import com.houhong.thirdpay.bean.common.Pay;
...
public abstract class AbstractWxPay extends AbstractWx implements Pay<WxTrade> {
    ...
    public TradeStatus status(WxTrade trade) {
        try {
             ...
             *   订单被关闭
             * */
            if ("CLOSED".equalsIgnoreCase(stateElement.getTextTrim())) {
            ...
            *
            **/
            if ("NOTPAY".equalsIgnoreCase(stateElement.getTextTrim())) {
    ...
    public TradeStatus statusRefund(WxTrade trade) throws DocumentException {
        /**
         * 构造参数
         */
        Map<String, String> params = new HashMap<String, String>();
        ...
        *
        **/
        if ("PROCESSING".equalsIgnoreCase(refundStatusElement.getTextTrim())) {
